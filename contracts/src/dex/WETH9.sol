...
/// @title WETH9
/// @notice Canonical Wrapped Ether. Deposit ETH to mint WETH 1:1 and withdraw
///         to burn WETH back into ETH. Behaviour matches the original mainnet
///         WETH9 contract, adapted to Solidity 0.8.x.
contract WETH9 {
