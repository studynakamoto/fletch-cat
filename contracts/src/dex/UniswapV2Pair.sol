...
/// @title UniswapV2Pair
/// @notice Full constant-product AMM pair. The pair is itself the LP token.
///         Adapted from canonical Uniswap v2 to Solidity 0.8.x: arithmetic that
///         intentionally wraps (TWAP accumulators, block timestamp) is placed
///         in `unchecked` blocks; everything else relies on native overflow
///         checks.
